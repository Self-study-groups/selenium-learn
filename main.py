...
row = driver.find_element(By.CSS_SELECTOR, '#main > div.D_aZm > div > div.D_aZy > main > div > div')
for data in row :
    judul = data.find_element(By.CSS_SELECTOR, 'div:nth-child(1) > div:nth-child(1) > div > div.D_jG > a:nth-child(2) > p.D_jm.D_gQ.D_jn.D_jq.D_jt.D_jw.D_jy.D_ju.D_jj').text
print(judul)
driver.quit()
